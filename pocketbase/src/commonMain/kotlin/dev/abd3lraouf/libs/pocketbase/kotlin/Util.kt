...
internal annotation class Untested(
...
public class PocketbaseException(
    ...
    public constructor(error: PocketbaseError) : this(
...
@Serializable
public data class AuthResponse<T : BaseModel>(
    @SerialName("record") val record: T,
    val token: String,
)
