...
import dev.abd3lraouf.libs.pocketbase.kotlin.recordAuthFrom
...
public interface AuthService {
    ...
    public data class AuthMethodsList(
        val password: PasswordAuthInfo,
        val oauth2: OAuth2AuthInfo,
        val mfa: GeneralAuthInfo,
        val otp: GeneralAuthInfo,
    )
