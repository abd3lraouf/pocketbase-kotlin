...
import dev.abd3lraouf.libs.pocketbase.kotlin.models.utils.DurationPocketbase
...
public open class AuthCollection(
     ...
     */
    public data class AuthAlertOptions(
    ...
    public data class OAuth2Options(
        val enabled: Boolean? = null,
        val providers: List<JsonElement>,
        val mappedFields: List<JsonElement>,
    )
     ...
     *    or "email" to log in.
     */
    public data class PasswordAuthOptions(
        val enabled: Boolean? = null,
